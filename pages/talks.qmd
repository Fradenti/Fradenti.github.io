...
FD <- add_presentation(presenter = fd,     
                       ...
                       lat = 45.4127, lon = 11.8925,            
                       event = "Non-Clinical Statistics Conference NCS 2026",
                       title = "Bayesian Nonparametrics Methods for Complex Biomedical Data",
                       link = "https://ncs-conference.org",
                       materials = "../img_pag/PLE_NCS2026.qmd",
                       type = "poster", institution = "Savhotel Padova", 
                       department = NA,
                       venue = NA, room = NA,
...
FD <- FD |> add_presentation(presenter = fd,     
                       ...
                       lat = 37.9818, lon = 23.7335,                  
                       event = "Compstat 2026",
                       title = "Bayesian nonparametric priors and discrete random structures for high-dimensional biological inference",
                       link = "hhttps://www.compstat2026.org",
                       materials = "../img_pag/INV_COMPSTAT26.qmd",
                       type = "poster", institution = "Athens University Law School", 
                       department = NA,
                       venue = NA, room = NA,
...
FD <- FD |> add_presentation(presenter = fd,     
                       ...
                       lat = 35.17065, lon = 136.88659,                  
                       event = "ISBA World Meeting 2026",
                       title = "Bayesian Multiresolution Functional Regression and Clustering via stCUSP",
                       link = "https://isba2026.github.io",
                       materials = "../img_pag/POS_ISBA26.qmd",
                       type = "poster", institution = "WINC AICI Center Nagoya", 
                       department = NA,
                       venue = NA, room = NA,
...
FD <- FD %>% add_presentation(presenter = fd,     
                       ...
                       lat = 35.6278, lon = 140.1031,                  
                       event = "BAYSM2026",
                       title = "Bayesian Multiresolution Functional Regression and Clustering via stCUSP",
                       link = "https://baysm2026.github.io",
                       materials = "../img_pag/INV_BAYSM26.qmd",
                       type = "presentation", institution = "Chiba University", 
                       department = NA,
                       venue = NA, room = NA,
                       year = 2026, month = 6, day = 27,
                       start_hour = NA, start_min = NA,
...
FD <- FD %>% add_presentation(presenter = fd,     
                       ...
                       lat = 60.20018600, lon = 25.04655000,                
                       event = "Nordstat",
                       title = "Bayesian Multiresolution Functional Regression and Clustering via stCUSP",
                       link = "https://www.helsinki.fi/en/conferences/nordstat-2026",
                       materials = "../img_pag/INV_Hels_26.qmd",
                       type = "presentation", institution = "University of Helsinky", 
                       department = NA,
                       venue = NA, room = NA,
...
FD <- FD %>% add_presentation(presenter = fd,     
                       ...
                       materials = "../img_pag/INV_Pauda25.qmd",
...
FD <- FD %>% add_presentation(presenter = fd,                         country = "Italy", city = "Padova",
                 lon = 11.88586, lat = 45.40797,
                 event = "GLASS informal seminar series",
                 title = "An informal intro to BNP mixture models",
                 link = "https://sites.google.com/view/laboratoriodistatisticasociale/appuntamenti-online?authuser=0",
                 materials = "../img_pag/...",
                 type = "seminar", 
...
- [Non-Clinical Statistics NCS 2026](https://ncs-conference.org/)  
Talk: *Bayesian Nonparametrics Methods for Complex Biomedical Data*  
Padova, ITA - September 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/PLE_NSC2026.qmd)
...
- [BAYMS 2026](https://)  
Talk: **  
Tokyo, JAP - June 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/INV_BAYSM26.qmd)
--->



- [COMPSTAT 2026](https://www.compstat2026.org/)  
Talk: *Bayesian nonparametric priors and discrete random structures for high-dimensional biological inference*  
Athens, GRE - August 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/INV_COMPSTAT26.qmd)



- [BAYSM26](https://baysm2026.github.io)  
Talk: *Bayesian Multiresolution Functional Regression and Clustering via stCUSP*  
Chiba, JAP - June 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/INV_BAYSM26.qmd)


- [Nordstat 2026](https://www.helsinki.fi/en/conferences/nordstat-2026)  
Talk: *Bayesian Multiresolution Functional Regression and Clustering via stCUSP*  
Helsinki, FIN - June 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/INV_Hels26.qmd)
...
- [GLASS informal seminar series](https://sites.google.com/view/laboratoriodistatisticasociale/home)  
Seminar (45 min): *An informal intro to BNP mixture models*  
Padova, IT - April 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/SEM_...)
...
- [ISBA 2026 World Meeting](https://isba2026.github.io)  
Poster: *Bayesian Multiresolution Functional Regression and Clustering via stCUSP*   
Nagoya, JAP - June 2026 - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/POS_ISBA2026.qmd)  
...
- [Skew 2026 - A class of distributions which includes the normal one: foundational contributions and recent advancements on skewed distributions](https://skew2026.stat.unipd.it)  
Padova, IT - January 2026  - [ <img  width="20" height="20" src="../images/cam3.png"> ](../img_pag/PAR_skew26.qmd)
