...
cbind("Annals of Applied Statistics (AOAS)", 3), 
cbind("Artificial Intelligence in Medicine", 1), 
cbind("Bayesian Analysis (BA)", 4), 
cbind("Biometrical Journal", (1)),
cbind("Biometrics", (3)),
cbind("Biostatistics", (1)),
...
cbind("International Journal of Data Science and Analytics", (1)),
...
cbind("Population Health Metrics", (1)),
cbind("Statistica Applicata",1),
cbind("Statistical Methods and Applications (SMAP)", 5),
cbind("Statistical Science", (2)),
cbind("Statistics and Computing", (4)),
