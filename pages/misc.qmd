...
```{r,echo=F}
D <- rbind(
cbind("Advances in Data Analysis and Classification" , 1),
...
cbind("Journal of the Royal Statistical Society - Series C (JRSS-C)",1),
...
cbind("Statistics and Computing", (5)),
...
+ Editor of the Springer Volume of Conference Proceedings (IFCS 2026) [Navigating ComplexityStatistical Methods, Data Analysis, and Machine Learning for Actionable Insights](https://link.springer.com/book/10.1007/978-3-032-32009-4)
