...
<button type="button" name="button" class="btn" style="background-color:white;color:blue;width: 24%;">[Google Scholar Profile](https://scholar.google.com/citations?user=DLiw19MAAAAJ&hl=en)</button>
<button type="button" name="button" class="btn" style="background-color:white;color:blue;width: 24%;">[Github Profile](https://github.com/Fradenti)</button>
<button type="button" name="button" class="btn" style="background-color:white;color:blue;width: 24%;">[ArXiv](https://arxiv.org/search/?searchtype=author&query=Denti%2C+F)</button>
<button type="button" name="button" class="btn" style="background-color:white;color:blue;width: 24%;">[ResearchGate](https://www.researchgate.net/profile/Francesco-Denti-2)</button>

### News and highlights

---

[2021/05/04] Our paper [*"A Two-Stage Bayesian Nonparametric Model for Novelty Detection with Robust Prior Information"*](https://arxiv.org/abs/2006.09012)  has been accepted for publication on *Statistics and Computing*
