...
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:blue;">[Article](https://doi.org/10.1214/23-AOAS1736)</button>
...
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:grey;">[Work in progress](/Rmarkdowns/Research)</button>
...
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:gray;">[Github](https://github.com/Fradenti/SANba)</button>

* **SANvi** - R package - In collaboration with L. D'Angelo  
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:blue;">[Github](https://github.com/Fradenti/SANvi)</button>
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:blue;">[CRAN](https://CRAN.R-project.org/package=SANvi)</button>  

* **SANple** - R package - In collaboration with L. D'Angelo    
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:blue;">[Github](https://github.com/laura-dangelo/SANple)</button>
<button type="button" name="button" class="btn btn-primary btn-sm" style="background-color:white;color:blue;">[CRAN](https://CRAN.R-project.org/package=SANple)</button>  
