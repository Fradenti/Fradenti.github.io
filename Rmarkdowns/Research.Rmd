...
**Biometrical Journal**, (Conditionally accepted) 2024 - [[GitHub](https://github.com/andreasottosanti/TRIFASE)]
...
cbind("2021 SBSS Student Paper Competition","--"),
cbind("IEEE CIBCB 2023 - Special Session","--"),
cbind("2024 ASA-SBSS Student Paper Competition","--")
)
D = as.data.frame(D)
D[,2] = as.numeric(D[,2])
