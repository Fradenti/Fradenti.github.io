...
```{r,echo=F}
corsi <- tibble(`Degree type` =".", Course = "", University = ".", Role = "",`  Year` = ".", Hours = ".", Language = ".")
...
kableExtra::kable_styling(kable(corsi[-1,])) %>% footnote(c("PI: Principal Instructor  -  TA: Teaching Assistant  -  vTA: volounteer Teaching Assistant"))
```
